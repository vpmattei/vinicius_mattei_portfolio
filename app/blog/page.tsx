    ...
    <section className="prose ml-8 mr-8 flex flex-col items-center">
      ...
      <div>
        ...
        <ul className="text-xl indent-8 text-justify">
          <li>
            Project Manager: Leading the team to ensure the project's vision
            came to fruition efficiently and effectively.
          </li>
          <li>
            Sound Designer: Implementing the auditory experience using Wwise,
            from ambient sounds to the dynamic soundtrack.
          </li>
          <li>
            Game Designer: Making sure the game feel was right and talking
            constantly with the developers to fine tune some mechanics.
          </li>
          <li>
            Level Designer: Constructing the base of the level and modifying a
            few more specific locations in the level.
          </li>
          <li>
            Developer: Implementing a few minor mechanics, specifically one used
            in a puzzle.
          </li>
        </ul>
